...
ActiveRecord::Schema.define(version: 20160827162040) do
  ...
  create_table "assignments", force: :cascade do |t|
    ...
    t.index ["idea_id"], name: "index_assignments_on_idea_id", using: :btree
  ...
  create_table "suggestions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["idea_id"], name: "index_suggestions_on_idea_id", using: :btree
